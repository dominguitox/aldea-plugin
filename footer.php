        ...
        <div class="site-info">
            <div class="container">
                <?php if ($onepress_btt_disable != '1'): ?>
                    <div class="btt">
                        <a class="back-to-top" href="#page" title="<?php echo esc_attr__('Back To Top', 'onepress'); ?>"><i
                                class="fa fa-angle-double-up wow flash" data-wow-duration="2s"></i></a>
                    </div>
                <?php endif; ?>
                <p>&copy; 2026
                    <span class="sep"> – </span>
                    Desarrollado por Jorgelio
                    <span class="sep"> – </span> <a href="https://paginaswebtalca.com/" target="_blank">Paginas web
                        Talca</a>
                </p>
            </div>
        </div>
